...
import {ProductsStoragePort} from "../../../src/lib/application/infrastructure/storage/products.storage-port";
import {ProductDto} from "../../../src/lib/application/infrastructure/dto/product.dto";

@Injectable()
export class MockProductsStorage implements ProductsStoragePort {
